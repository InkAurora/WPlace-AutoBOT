(async () => {
  ...
  class OverlayManager {
    ...
    async _doProcessImageIntoChunks() {
      ...
      console.log(
        `✅ Overlay processed ${this.chunkedTiles.size} tiles in ${Math.round(
          processingTime
        )}ms`
      );
    }
  ...
  const Utils = {
    ...
    findClosestPaletteColor: (r, g, b, palette) => {
      ...
      if (
        palette.every(
          (c) => Object.prototype.toString.call(c) === "[object Object]"
        )
      ) {
        palette = palette
    ...
    findColorId: (r, g, b) => {
      const color = Object.values(CONFIG.COLOR_MAP)
        .filter((color) => color.rgb !== null)
        .find(
          (color) => color.rgb.r === r && color.rgb.g === g && color.rgb.b === b
        );
    ...
    extractAvailableColors: () => {
      ...
      console.log(
        `Total colors scanned: ${
          availableColors.length + unavailableColors.length
        }`
      );
      ...
      if (availableColors.length > 0) {
        ...
        availableColors.forEach((color, index) => {
          console.log(
            `${index + 1}. ID: ${color.id}, Name: "${color.name}", RGB: (${
              color.rgb[0]
            }, ${color.rgb[1]}, ${color.rgb[2]})`
          );
        });
      }
      ...
      if (unavailableColors.length > 0) {
        ...
        unavailableColors.forEach((color, index) => {
          console.log(
            `${index + 1}. ID: ${color.id}, Name: "${color.name}", RGB: (${
              color.rgb[0]
            }, ${color.rgb[1]}, ${color.rgb[2]}) [LOCKED]`
          );
        });
      }
  ...
  async function createUI() {
    ...
    style.textContent = `
      ...
      CONFIG.currentTheme === "Classic Autobot" ? theme.accent : theme.text
    };
      ...
      .wplace-header {
        padding: ${
          CONFIG.currentTheme === "Neon Retro" ? "8px 12px" : "8px 12px"
        };
        background: ${
          CONFIG.currentTheme === "Classic Autobot"
        ...
        user-select: none;
        border-bottom: ${
          CONFIG.currentTheme === "Neon Retro" ? "2px" : "1px"
        } solid ${
      CONFIG.currentTheme === "Classic Autobot"
      ...
      .wplace-header-btn {
        ...
        cursor: pointer;
        border-radius: ${
          CONFIG.currentTheme === "Classic Autobot" ? "4px" : "0"
        };
      ...
      .wplace-header-btn:hover {
        ...
        color: ${
          CONFIG.currentTheme === "Classic Autobot" ? theme.text : theme.primary
        };
        transform: ${
          CONFIG.currentTheme === "Classic Autobot" ? "scale(1.1)" : "none"
        };
        ${
          CONFIG.currentTheme === "Neon Retro"
            ? `box-shadow: 0 0 10px ${theme.text};`
            : ""
        }
      }
      ...
      .wplace-section {
        margin-bottom: ${
          CONFIG.currentTheme === "Neon Retro" ? "12px" : "12px"
        };
        padding: 12px;
        background: rgba(255,255,255,0.03);
        border-radius: ${theme.borderRadius};
      ...
      .wplace-btn {
        padding: ${
          CONFIG.currentTheme === "Neon Retro" ? "12px 8px" : "8px 12px"
        };
        ...
        ${
          CONFIG.currentTheme === "Neon Retro"
            ? "text-transform: uppercase; letter-spacing: 1px; image-rendering: pixelated;"
            : ""
        }
        background: ${
          CONFIG.currentTheme === "Classic Autobot"
      ...
      .wplace-btn-start {
        ...
        color: ${
          CONFIG.currentTheme === "Classic Autobot" ? "white" : theme.primary
        };
        ${
          CONFIG.currentTheme === "Neon Retro"
      ...
      .wplace-btn-stop {
        ...
        color: ${
          CONFIG.currentTheme === "Classic Autobot" ? "white" : theme.text
        };
        ${
          CONFIG.currentTheme === "Neon Retro"
      ...
      .wplace-progress-bar {
        ...
        transition: width ${
          CONFIG.currentTheme === "Neon Retro" ? "0.3s" : "0.5s"
        } ease;
        position: relative;
        ${
          CONFIG.currentTheme === "Neon Retro"
      ...
      .wplace-status {
        ...
        border: ${
          CONFIG.currentTheme === "Neon Retro" ? "2px solid" : "1px solid"
        };
        border-radius: ${theme.borderRadius};
        text-align: center;
        font-size: ${CONFIG.currentTheme === "Neon Retro" ? "8px" : "11px"};
      ...
      .status-error {
        ...
        border-color: ${theme.error};
        color: ${
          CONFIG.currentTheme === "Classic Autobot" ? theme.error : theme.text
        };
      ...
      .status-warning {
        ...
        border-color: ${theme.warning};
        color: ${
          CONFIG.currentTheme === "Classic Autobot" ? "orange" : theme.primary
        };
  ...
  .resize-canvas-stack { position: relative; transform-origin: center center; display: inline-block; }
      ...
      .wplace-btn.active i,
      .wplace-btn[aria-pressed="true"] i { filter: drop-shadow(0 0 3px ${
        theme.primary
      }); }
      ...
      .resize-slider {
        ...
        background: ${
          CONFIG.currentTheme === "Classic Autobot" ? "#ccc" : theme.secondary
        };
        border: ${
          CONFIG.currentTheme === "Neon Retro"
            ? `2px solid ${theme.text}`
    ...
    settingsContainer.style.cssText = `
      ...
      border: ${theme.borderWidth || "1px"} ${theme.borderStyle || "solid"} ${
    ...
    settingsContainer.innerHTML = `
      <div class="wplace-settings-header" style="
        background: ${
          theme.accent ? `${theme.accent}33` : "rgba(255,255,255,0.1)"
        }; 
        padding: 20px; 
      ...
      ">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <button id="closeSettingsBtn" style="
            background: ${
              theme.accent ? `${theme.accent}66` : "rgba(255,255,255,0.1)"
            };
            color: ${theme.text || "white"};
          ...
          " onmouseover="
            ...
            ${
              theme.animations?.glow
                ? `this.style.boxShadow='0 0 20px ${theme.error || "#ff0000"}';`
                : ""
            }
          " onmouseout="
      ...
      <div style="padding: 25px; max-height: 70vh; overflow-y: auto;">
        ...
        <div style="margin-bottom: 25px;">
          ...
          <div style="background: rgba(255,255,255,0.1); border-radius: 12px; padding: 18px; border: 1px solid rgba(255,255,255,0.1);">
            ...
            ">
              ...
              } style="background: #2d3748; color: white; padding: 10px;">🤖 Automatic Token Generator (Recommended)</option>
              <option value="hybrid" ${
                state.tokenSource === "hybrid" ? "selected" : ""
              } style="background: #2d3748; color: white; padding: 10px;">🔄 Generator + Auto Fallback</option>
              <option value="manual" ${
                state.tokenSource === "manual" ? "selected" : ""
              } style="background: #2d3748; color: white; padding: 10px;">🎯 Manual Pixel Placement</option>
            </select>
        ...
        <div style="margin-bottom: 25px;">
          <label style="display: block; margin-bottom: 12px; color: ${
            theme.text || "white"
          }; font-weight: 500; font-size: 16px; display: flex; align-items: center; gap: 8px;">
            <i class="fas fa-eye" style="color: ${
          ...
          ">
              ...
              <div style="margin-bottom: 15px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                   <span style="font-weight: 500; font-size: 13px; color: ${
                     theme.text || "white"
              ...
              <label for="enableBlueMarbleToggle" style="display: flex; align-items: center; justify-content: space-between; cursor: pointer;">
                  <div>
                      ...
                      }; margin: 4px 0 0 0;">Renders a dithered "shredded" overlay.</p>
                  </div>
        ...
        <div style="margin-bottom: 25px;">
          ...
          <div style="background: rgba(255,255,255,0.1); border-radius: 12px; padding: 18px; border: 1px solid rgba(255,255,255,0.1); display:flex; flex-direction:column; gap:10px;">
            ...
            <div style="display:flex; align-items:center; gap:10px;">
              ...
              }" style="width:70px; padding:6px 8px; border-radius:6px; border:1px solid rgba(255,255,255,0.2); background: rgba(255,255,255,0.08); color:#fff;" />
              <span>minute(s)</span>
            </div>
              ...
              ${Object.keys(CONFIG.THEMES)
                .map(
                  (themeName) =>
                    ...
                    } style="background: #2d3748; color: white; padding: 10px;">${themeName}</option>`
                )
                .join("")}
            </select>
          </div>
        ...
        <div style="margin-bottom: 25px;">
          ...
          <div style="background: rgba(255,255,255,0.1); border-radius: 12px; padding: 18px; border: 1px solid rgba(255,255,255,0.1);">
            ...
            ">
              ...
              } style="background: #2d3748; color: white;">🇻🇳 Tiếng Việt</option>
              <option value="id" ${
                state.language === "id" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇮🇩 Bahasa Indonesia</option>
              <option value="ru" ${
                state.language === "ru" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇷🇺 Русский</option>
              <option value="en" ${
                state.language === "en" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇺🇸 English</option>
              <option value="pt" ${
                state.language === "pt" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇧🇷 Português</option>
              <option value="fr" ${
                state.language === "fr" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇫🇷 Français</option>
              <option value="tr" ${
                state.language === "tr" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇹🇷 Türkçe</option>
              <option value="zh" ${
                state.language === "zh" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇨🇳 简体中文</option>
              <option value="zh-tw" ${
                state.language === "zh-tw" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇹🇼 繁體中文</option>
              <option value="ja" ${
                state.language === "ja" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇯🇵 日本語</option>
              <option value="ko" ${
                state.language === "ko" ? "selected" : ""
              } style="background: #2d3748; color: white;">🇰🇷 한국어</option>
              </select>
          </div>
        </div>
    ...
    resizeContainer.innerHTML = `
      <h3 style="margin-top: 0; color: ${theme.text}">${Utils.t(
      "resizeImage"
    )}</h3>
        ...
        <div style="display:flex; flex-direction:column; gap:10px;">
          ...
          <div>
            <div style="display:flex; justify-content:space-between; font-size:11px; margin-bottom:4px;">
              ...
              <span id="chromaWeightValue" style="background:rgba(255,255,255,0.08); padding:2px 6px; border-radius:4px;">${
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
            <label style="display:flex; flex-direction:column; gap:4px; font-size:12px;">
              ...
              }" style="padding:6px 8px; border-radius:6px; border:1px solid rgba(255,255,255,0.15); background: rgba(255,255,255,0.05); color:#fff;" />
            </label>
            <label style="display:flex; flex-direction:column; gap:4px; font-size:12px;">
    ...
    updateStats = async () => {
      ...
      if (state.colorsChecked) {
        colorSwatchesHTML = state.availableColors
          .map((color) => {
            ...
            return `<div class="wplace-stat-color-swatch" style="background-color: ${rgbString};" title="ID: ${
              color.id
      ...
      statsArea.innerHTML = `
            ...
            <div class="wplace-stat-value">${Math.floor(
              state.currentCharges
            )} / ${state.maxCharges}</div>
            </div>
            ${
              state.colorsChecked
                ? `
    ...
    try {
      ...
      outerLoop: for (let y = 0; y < height; y++) {
        for (let x = 0; x < width; x++) {
          ...
          const colorId = findExactColor(
            targetRgb,
            state.availableColorPalette
          );
          ...
          const canvasColor = getCachedPixelColor(
            regionX + adderX,
            regionY + adderY,
            pixelX,
            pixelY
          ...
          if (canvasColor && canvasColor[3] >= CONFIG.TRANSPARENCY_THRESHOLD) {
            ...
            canvasColorId = Utils.findColorId(
          ...
          if (
            ...
            if (pixelBatch && pixelBatch.pixels.length > 0) {
              console.log(
                ...
                } pixels (switching to region ${regionX + adderX},${
                  regionY + adderY
                })`
              );
              updateUI(
          ...
          if (
            ...
            while (1) {
              ...
              if (state.accountSwapperEnabled && !hasSwapped) {
                updateUI("Switching to next account", "default");
